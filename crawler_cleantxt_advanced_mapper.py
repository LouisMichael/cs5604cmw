...
if __name__ == "__main__":
    ...
    for url in sys.stdin:
        ...
        #I pulled out col_event adn col_id until I better understand how to pass that info as a parameter. 
        newline_m = ["webpage"]
        ...
        newline_c = [webtext, webtext_profanity, webKeywords, webtokens, webstem, weblemma, webPOS, nerPerson, nerOrg, nerLocation]
        
        newline_list += newline_m + newline_w + newline_c
        
        newline = "\t".join(newline_list)+"\n"
        print(newline.encode('utf8'))
